...
class DonorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donor" do
    assert_difference('Donor.count') do
      post donors_url, params: { donor: { email: @donor.email, location: @donor.location, name: @donor.name, phoneNumber: @donor.phoneNumber } }
    end
  ...
  test "should update donor" do
    patch donor_url(@donor), params: { donor: { email: @donor.email, location: @donor.location, name: @donor.name, phoneNumber: @donor.phoneNumber } }
