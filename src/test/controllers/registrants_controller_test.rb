...
class RegistrantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registrant" do
    assert_difference('Registrant.count') do
      ...
      post registrants_url, params: { registrant: { county: @registrant.county, email: @registrant.email, first_name: @registrant.first_name, job: @registrant.job, last_name: @registrant.last_name, listserv: @registrant.listserv, topics: @registrant.topics, webinar: @registrant.webinar } }
  ...
  test "should update registrant" do
    ...
    patch registrant_url(@registrant), params: { registrant: { county: @registrant.county, email: @registrant.email, first_name: @registrant.first_name, job: @registrant.job, last_name: @registrant.last_name, listserv: @registrant.listserv, topics: @registrant.topics, webinar: @registrant.webinar } }
